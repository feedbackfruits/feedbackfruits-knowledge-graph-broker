        ...
        const receive = (send) => (operation) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield Promise.all(quads.map((quad) => __awaiter(this, void 0, void 0, function* () {
                    let nquads, doc;
                    try {
                        nquads = feedbackfruits_knowledge_engine_1.Quad.toNQuads([quad]);
                        quads = feedbackfruits_knowledge_engine_1.Quad.fromNQuads(nquads);
                        doc = yield feedbackfruits_knowledge_engine_1.Doc.fromQuads(quads, feedbackfruits_knowledge_engine_1.Context.context);
                    }
                    catch (e) {
